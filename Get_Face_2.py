...
file_lin = 'D:/PycharmWorkSpace/MScProj/data/140-girl1.dat'
...
def extract_face(x_train):
    ...
    plt.imsave('./data/faces/gi/x_mean.png', x_train_mean)
    x_train = x_train[0:112, :, :]
    # for i in range(np.size(x_train, 2)):
    #     plt.imsave('./data/faces/gi/train_' + str(i) + '.png', x_train[:, :, i])
    # x_test = x_test[0:204, :, :]
    x_train_mean = np.mean(x_train, 2)
    plt.imsave('./data/faces/gi/face_mean.png', x_train_mean)
    ...
    plt.imsave('./data/faces/gi/face_mean.png', x_train_mean_cut)
    ...
    for i in range(np.size(x_train, 2)):
        ...
        plt.imsave('./data/faces/gi/train_' + str(i) + '.png', x_train_cut[:, :, i])
